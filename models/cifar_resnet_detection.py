...
class CIFAR_ResNet(nn.Module):
    ...
    def __init__(self, head='mlp', feat_dim=128, num_class=0, pretrained=False):
        ...
        self.fc1 = nn.Linear(dim_in, num_class)
        if head == 'linear':
    ...
    def forward(self, x):
        ...
        logits = self.fc(feat)
        one_vs_all = self.fc1(feat)
        return logits, F.normalize(feat_c, dim=1), feat, one_vs_all
